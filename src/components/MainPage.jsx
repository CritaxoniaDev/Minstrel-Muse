...
const MainPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative mt-[-6.6rem] overflow-hidden">
            ...
            <div className={`
            absolute inset-0 
            [background-size:25px_25px] md:[background-size:50px_50px]
            [mask-size:25px_25px] md:[mask-size:50px_50px]
            ...
            `}>
                ...
                {[...Array(isMobile ? 4 : 8)].map((_, i) => (
                    <div
                        key={`hl-${i}`}
                        className="absolute h-[2px] w-[100px] md:w-[200px] animate-grid-beam-horizontal"
                        style={{
                            background: 'linear-gradient(90deg, transparent, rgba(168, 85, 247, 0.8), transparent)',
                            top: `${Math.floor(Math.random() * (isMobile ? 10 : 20)) * 50}px`,
                            left: '0',
                            animationDelay: `${i * (isMobile ? 2 : 1.5)}s`
                        }}
                    />
                ))}
            ...
            <div className="absolute inset-0 -z-10">
                {[...Array(3)].map((_, i) => (
                    <div
                        key={i}
                        className={`
                            absolute rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse
                            ${i === 0 ? 'bg-purple-300 h-36 w-36 md:h-72 md:w-72 -top-5 -left-5 md:-top-10 md:-left-10' : ''}
                            ${i === 1 ? 'bg-blue-300 h-48 w-48 md:h-96 md:w-96 top-10 right-6 md:top-20 md:right-12' : ''}
                            ${i === 2 ? 'bg-violet-300 h-36 w-36 md:h-72 md:w-72 bottom-10 left-10 md:bottom-20 md:left-20' : ''}
                        `}
                        style={{
            ...
            {/* Main Content */}
            <motion.div
                className="text-center z-10 space-y-4 md:space-y-6 backdrop-blur-[1px] p-4 md:p-8 rounded-2xl"
            ...
            >
                ...
                <div className="relative">
                    ...
                    <svg className="hidden md:block absolute -left-12 -top-8 w-12 h-12 text-purple-500 animate-pulse opacity-70">
                    ...
                    <svg className="hidden md:block absolute -right-12 -top-8 w-12 h-12 text-blue-500 animate-pulse opacity-70">
                        {/* ... SVG path content ... */}
